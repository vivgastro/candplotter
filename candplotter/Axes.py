...
class MainAxis:
    ...
    def plot(self):
        ...
        self.ax.scatter(self.collection.df[self.collection.X_label], self.collection.df[self.collection.Y_label], s = self.collection.df[self.collection.size_label], c=self.collection.df[self.collection.color_label], alpha=0.75, cmap='jet', picker = True)
